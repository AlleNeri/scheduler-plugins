...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LogPlugArgs) DeepCopyInto(out *LogPlugArgs) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	if in.Timeout != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LogPlugArgs.
func (in *LogPlugArgs) DeepCopy() *LogPlugArgs {
	if in == nil {
		return nil
	}
	out := new(LogPlugArgs)
...
// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *LogPlugArgs) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
