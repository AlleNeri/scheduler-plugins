...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*LogPlugArgs)(nil), (*config.LogPlugArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_LogPlugArgs_To_config_LogPlugArgs(a.(*LogPlugArgs), b.(*config.LogPlugArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.LogPlugArgs)(nil), (*LogPlugArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_LogPlugArgs_To_v1_LogPlugArgs(a.(*config.LogPlugArgs), b.(*LogPlugArgs), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1_LogPlugArgs_To_config_LogPlugArgs(in *LogPlugArgs, out *config.LogPlugArgs, s conversion.Scope) error {
...
// Convert_v1_LogPlugArgs_To_config_LogPlugArgs is an autogenerated conversion function.
func Convert_v1_LogPlugArgs_To_config_LogPlugArgs(in *LogPlugArgs, out *config.LogPlugArgs, s conversion.Scope) error {
	return autoConvert_v1_LogPlugArgs_To_config_LogPlugArgs(in, out, s)
}

func autoConvert_config_LogPlugArgs_To_v1_LogPlugArgs(in *config.LogPlugArgs, out *LogPlugArgs, s conversion.Scope) error {
...
// Convert_config_LogPlugArgs_To_v1_LogPlugArgs is an autogenerated conversion function.
func Convert_config_LogPlugArgs_To_v1_LogPlugArgs(in *config.LogPlugArgs, out *LogPlugArgs, s conversion.Scope) error {
	return autoConvert_config_LogPlugArgs_To_v1_LogPlugArgs(in, out, s)
}
