...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*OptimizedPreemptionArgs)(nil), (*config.OptimizedPreemptionArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_OptimizedPreemptionArgs_To_config_OptimizedPreemptionArgs(a.(*OptimizedPreemptionArgs), b.(*config.OptimizedPreemptionArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.OptimizedPreemptionArgs)(nil), (*OptimizedPreemptionArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_OptimizedPreemptionArgs_To_v1_OptimizedPreemptionArgs(a.(*config.OptimizedPreemptionArgs), b.(*OptimizedPreemptionArgs), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1_OptimizedPreemptionArgs_To_config_OptimizedPreemptionArgs(in *OptimizedPreemptionArgs, out *config.OptimizedPreemptionArgs, s conversion.Scope) error {
	if err := metav1.Convert_Pointer_int64_To_int64(&in.Timeout, &out.Timeout, s); err != nil {
		return err
	}
	return nil
}

// Convert_v1_OptimizedPreemptionArgs_To_config_OptimizedPreemptionArgs is an autogenerated conversion function.
func Convert_v1_OptimizedPreemptionArgs_To_config_OptimizedPreemptionArgs(in *OptimizedPreemptionArgs, out *config.OptimizedPreemptionArgs, s conversion.Scope) error {
	return autoConvert_v1_OptimizedPreemptionArgs_To_config_OptimizedPreemptionArgs(in, out, s)
}

func autoConvert_config_OptimizedPreemptionArgs_To_v1_OptimizedPreemptionArgs(in *config.OptimizedPreemptionArgs, out *OptimizedPreemptionArgs, s conversion.Scope) error {
	if err := metav1.Convert_int64_To_Pointer_int64(&in.Timeout, &out.Timeout, s); err != nil {
		return err
	}
	return nil
}

// Convert_config_OptimizedPreemptionArgs_To_v1_OptimizedPreemptionArgs is an autogenerated conversion function.
func Convert_config_OptimizedPreemptionArgs_To_v1_OptimizedPreemptionArgs(in *config.OptimizedPreemptionArgs, out *OptimizedPreemptionArgs, s conversion.Scope) error {
	return autoConvert_config_OptimizedPreemptionArgs_To_v1_OptimizedPreemptionArgs(in, out, s)
}
